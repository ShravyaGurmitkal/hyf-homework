...
function setWinnerImage() {
    const winnerGif = document.getElementById('winnerGifMarkup');
    winnerGif.setAttribute('src', 'https://media1.giphy.com/media/01zhHXNedw9TDp2b0h/giphy.gif?cid=790b7611e9f0875ec2077f3163d39a253a329ebace015577&rid=giphy.gif&ct=g');
    winnerGif.setAttribute('alt', 'WinnerGif');
}
...
function countTimer() {
    if(secs >= timeInputValue) {
        ...
        document.getElementById('timer').innerHTML = `Game is for ${timeInputValue} seconds , Timer : ${timeInputValue} seconds completed, Time is up!!!!`
    } else {
